...
* 
* This version should be passed with both bonus points
* Author: Flaxen
* Tags: 
*/
...
global {
	...
	init {
		...
		loop counter from: 1 to: numberOfGuards {
...
species SecurityGuard skills: [moving] {
	...
	reflex gotoTargetPoint when: targetLocation != nil and target = nil {
